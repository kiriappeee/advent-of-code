...
class TestComputer(unittest.TestCase):
    def test_an_instruction_is_recognised_as_so(self):
        self.assertTrue(computer.is_instruction(1))
        self.assertTrue(computer.is_instruction(2))
        self.assertTrue(computer.is_instruction(3))
        self.assertTrue(computer.is_instruction(4))
        self.assertTrue(computer.is_instruction(99))
        self.assertTrue(computer.is_instruction(104))
        self.assertTrue(computer.is_instruction(1105))
        self.assertFalse(computer.is_instruction(100))
        self.assertFalse(computer.is_instruction(1204))
        self.assertFalse(computer.is_instruction(100004))
    def test_operators_are_split_correctly(self):
        ...
        self.assertEqual(computer.getNextOperationMembers(test_array), expected_result)
    ...
    def test_numbers_are_read_and_multiplied_correctly(self):
        ...
        self.assertEqual(computer.executeOperation(operation_specification, test_array), 200)
    ...
    def test_operation_receives_none_on_99(self):
        ...
        self.assertIsNone(computer.executeOperation(operation_specification, test_array))
    ...
    def test_opcode_four_outputs_number_in_position(self):
        ...
        self.assertEqual(computer.executeOperation(operation_specification, test_array), 21)
    ...
    def test_opcode_five_returns_jump_value_correctly(self):
        ...
        self.assertEqual(computer.executeOperation(operation_specification, test_array), 4)
        ...
        self.assertEqual(computer.executeOperation(operation_specification, test_array), 2)
        ...
        self.assertEqual(computer.executeOperation(operation_specification, test_array), -1)
    ...
    def test_opcode_seven_returns_value_to_store_correctly(self):
        ...
        self.assertEqual(computer.executeOperation(operation_specification, test_array), 0)
