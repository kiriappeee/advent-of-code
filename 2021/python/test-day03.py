...
class TestDay03(unittest.TestCase):
    ...
    def test_gamma_and_epilson_rate_for_given_position(self):
        gamma_answer, epilson_answer = day03.get_gamma_and_epilson_rate_for_pos(self.test_input, 0)
        self.assertEqual(gamma_answer, 1)
        self.assertEqual(epilson_answer, 0)
        gamma_answer, epilson_answer = day03.get_gamma_and_epilson_rate_for_pos(self.test_input, 1)
    ...
    def test_ratings_for_o2_returned_for_given_position(self):
        ...
        self.assertEqual(o2_rating_list, ["11110", "10110", "10111", "10101", "11100", "10000", "11001"])
